	    ...
	    function init_form_fields() {
	    	...
	    	$this->form_fields = array(
				...
				'instructions' => array(
					...
					'default'     => __( 'After placing your order, please send an Email money transfer to the following:\nEmail: xxx@yyy.com\nSecret Question: Your Order Number {1}\nSecret Answer: {2} (MAKE SURE YOU DO NOT REMOVE THESE TWO PARAMETERS)\nThanks for choosing us! We appreciate your business.', 'woocommerce' ),
					'desc_tip'    => true,
				),
